...
| 4 开篇 | Q10 → 06 → 07 → Q4 → Q5 → Q6 → 08 → 09 → Q1 → Q2 → 10 | `_opening` (act=1) | 章节上下文包 + 剧情/指南 + `正文v1.md` + `状态v1.md` |
| 5 创作循环 | Q10 → 11 → 12 → Q4 → Q5 → Q6 → 13 → 14 → Q1 → Q2 → 15 → 16 | `_round_<n>` | 章节上下文包 + 剧情 + 写作指南 + `正文v<n>.md` + `状态v<n>.md` + 精简 `故事总梗概.md` |
