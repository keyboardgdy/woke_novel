...
Read: `{guides}/Writing_Guide_v1.md`
...
The novel prose is only the natural result of character behavior.
...
Write to `{output}/Draft_v1.md`.

Output path: `{output}/Draft_v1.md`
